...
//     type Ok = S::Ok;
//     type SerializeList<'sl> = ListSerializeAdapter<S>
//     where
//         Self: 'sl;
//
//     type SerializeMap<'sm> = MapSerializerAdapter<S>
//     where
//         Self: 'sm;
//     type SerializeStruct<'s> = StructSerializerAdapter<S>
//     where
//         Self: 's;
//
//     #[inline]
...
//         schema: &'a Schema,
//         len: usize,
//     ) -> Result<Self::SerializeStruct<'a>, Self::Error>
//     where Self: 'a
//     {
...
//         _schema: &'a Schema,
//         len: usize
//     ) -> Result<Self::SerializeMap<'a>, Self::Error>
//     where Self: 'a
//     {
...
//         _schema: &'a Schema,
//         len: usize,
//     ) -> Result<Self::SerializeList<'a>, Self::Error>
//     where Self: 'a
//     {
