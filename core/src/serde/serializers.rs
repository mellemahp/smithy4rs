...
pub trait StructSerializer {
    ...
    fn serialize_optional_member<T: Serialize>(&mut self, member_schema: &SchemaRef, value: &Option<T>) -> SerializerResult<Self::Error> {
...
pub trait Serializer: Sized {
    ...
    fn write_struct(&mut self, schema: &SchemaRef, len: usize) -> Result<Self::SerializeStruct<'_>, Self::Error>;
    fn write_map(&mut self, schema: &SchemaRef, len: usize) -> Result<Self::SerializeMap<'_>, Self::Error>;
