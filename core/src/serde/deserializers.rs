...
///
/// The deserializer is stateful and methods take `self` to advance through the input.
pub trait Deserializer<'de>: Sized {
    ...
    fn read_bool(self, schema: &SchemaRef) -> Result<bool, Self::Error>;
    ...
    fn read_document(self, schema: &SchemaRef) -> Result<Box<dyn Document>, Self::Error>;
