...
package gradle.kotlin.dsl.plugins._4c498fac1dc556e8dbe56edac20ab806
...
/**
 * The `com.adarshr` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComAdarshrPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.adarshr`.
 */
internal
val `ComPluginGroup`.`adarshr`: `ComAdarshrPluginGroup`
    get() = `ComAdarshrPluginGroup`(plugins)


/**
 * The `com.adarshr.test-logger` plugin implemented by [com.adarshr.gradle.testlogger.TestLoggerPlugin].
 */
internal
val `ComAdarshrPluginGroup`.`test-logger`: PluginDependencySpec
    get() = plugins.id("com.adarshr.test-logger")
...
/**
 * The `com.github.spotbugs` plugin implemented by [com.github.spotbugs.snom.SpotBugsPlugin].
 */
internal
val `ComGithubPluginGroup`.`spotbugs`: PluginDependencySpec
    get() = plugins.id("com.github.spotbugs")


/**
 * The `com.github.spotbugs-base` plugin implemented by [com.github.spotbugs.snom.SpotBugsBasePlugin].
 */
internal
val `ComGithubPluginGroup`.`spotbugs-base`: PluginDependencySpec
    get() = plugins.id("com.github.spotbugs-base")
