// TODO(test): add some test macro_utils for validating the serialized json outputs, perhaps snapshots would suffice
use smithy4rs_core::{IndexMap, serde::se::SerializeWithSchema};
