...
fn test_missing_required_field() {
    ...
    let builder = SimpleStructBuilder::deserialize_with_schema(&SIMPLE_STRUCT, &mut de)
...
fn test_null_for_required_field() {
    ...
    let mut de = JsonDeserializer::new(json);
    let result = SimpleStructBuilder::deserialize_with_schema(&SIMPLE_STRUCT, &mut de);
